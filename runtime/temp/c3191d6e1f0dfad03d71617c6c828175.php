<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"./application/index/view/default/Index\article_article.html";i:1552316628;s:73:"D:\Apache24\htdocs\starcms\application\index\view\default\index\head.html";i:1552315864;s:73:"D:\Apache24\htdocs\starcms\application\index\view\default\index\foot.html";i:1552222519;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="UTF-8">
...
<nav class="breadcrumb">
  ...
  <div id="content" class="site-content">
   ...
   <article class="post type-post status-publish format-standard hentry category-ality-original tag-ality-original tag-wordpress">
    <header class="entry-header"><h1><?php echo $info['title']; ?></h1></header>
    <div class="entry-content">
        <div class="single-content"><?php echo $info['content']; ?></div>
        <div class="clear"></div>
    ...
    <div id="sidebar" class="widget-area">
      ...
      <aside class="widget widget_hot_commend">
        ...
        <div id="hot" class="hot_commend">
          <ul>
            {Article:article catid="$catid" row="3" flag="r"}
            <li>
      ...
      <aside class="widget widget_hot_post">
        ...
        <div id="hot_post_widget">
          <ul>
            {Article:article catid="$catid" row="5" orderby="views"}

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/index/view/default/Index\product_list.html";i:1552201670;s:73:"D:\Apache24\htdocs\starcms\application\index\view\default\index\head.html";i:1552315864;s:73:"D:\Apache24\htdocs\starcms\application\index\view\default\index\foot.html";i:1552222519;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
      ...
      <main id="main" class="site-main">
        ...
        <article class="post type-post status-publish format-standard hentry">
          ...
          <header class="entry-header">
            <h2 class="entry-title"><a href="<?php echo url('info',array('id'=>$vo['id'],'catid'=>$vo['catid'])); ?>" rel="bookmark"><?php echo $vo['title']; ?></a></h2>
          </header>
          ...
          <span class="entry-more"> <a href="<?php echo url('info',array('id'=>$vo['id'],'catid'=>$vo['catid'])); ?>" rel="bookmark">阅读全文</a></span>
        </article>
		<?php endforeach; endif; else: echo "" ;endif; ?>
